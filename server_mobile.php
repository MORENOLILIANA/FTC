<?php
/**
 * Servidor Móvil Optimizado
 * 
 * Este servidor está configurado específicamente para acceso desde dispositivos móviles
 * Sirve en múltiples interfaces y puertos para máxima compatibilidad
 */
